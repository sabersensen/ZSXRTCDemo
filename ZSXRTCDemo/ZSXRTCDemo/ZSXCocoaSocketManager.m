...
@interface ZSXCocoaSocketManager()<GCDAsyncSocketDelegate>
{
...
@implementation ZSXCocoaSocketManager

+ (instancetype)share
{
    static dispatch_once_t onceToken;
    static ZSXCocoaSocketManager *instance = nil;
