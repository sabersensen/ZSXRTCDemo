...
@interface ZSXWebSocketManager()<SRWebSocketDelegate>
{
...
@implementation ZSXWebSocketManager

+ (instancetype)share
{
    static dispatch_once_t onceToken;
    static ZSXWebSocketManager *instance = nil;
